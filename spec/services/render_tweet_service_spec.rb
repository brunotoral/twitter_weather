...
RSpec.describe RenderTweetService do
  ...
  describe '.composed_message' do
    it 'returns forecast informations' do
      ...
      expect(render.composed_message).to eq '30.36°C e nublado em Natal em 08/02. Média para os próximos dias: 27.8°C em 07/02, 27.3°C em 08/02, 27.3°C em 09/02, 27.4°C em 10/02 e 27.9°C em 11/02.'
    end
  end
end
